...
@section('content')
    ...
    <div>
        <div class="bg-white relative flex items-center justify-center mt-8 w-full" style="height: 60vh;">
            <img src="{{ asset('images/back.jpg') }}" alt="Coconut"
                class="absolute inset-0 object-cover w-full h-full opacity-80">
            <div class="z-10 text-center px-4">
                <h1 class="text-2xl sm:text-2xl font-serif">SUPER QUALITY</h1>
                <p class="text-4xl sm:text-5xl font-serif">INDONESIA COCONUT</p><br>
                <a href="/product">
                    <button class="bg-yellow-400 text-white px-4 py-2 rounded-full hover:bg-yellow-500">Go to
                        Products</button>
                </a>
            </div>
        </div>
        ...
        <div class="flex mt-6">
            <div class="w-1/4 px-2 mb-4">
                <div class="text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-2 w-8 h-8" fill="currentColor"
                        viewBox="0 0 512 512" stroke-width="1.5" stroke="currentColor">
                        <path
            ...
            <div class="w-1/4 px-2 mb-4">
                <div class="text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="mx-auto mb-2 w-10 h-10">
                        <path
        ...
        <div class="flex flex-wrap mt-6">
            ...
            <div class="w-full md:w-1/3 px-4 mb-4">
                <div class="relative rounded-lg overflow-hidden">
                    ...
                    <div class="absolute bottom-0 left-0 bg-opacity-50 p-4 w-full">
                        ...
                        <a href="/product">
                            <button
                                class="bg-yellow-400 text-white mt-2 px-3 py-1.5 text-sm rounded-full hover:bg-yellow-500">All
                                Products</button>
                        </a>
                    </div>
                </div>
            ...
            <div class="w-full md:w-1/3 px-4 mb-4">
                <div class="relative rounded-lg overflow-hidden">
                    <img src="{{ asset('images/product2.jpg') }}" alt="Coconut Clear Bottle Image"
            ...
            <div class="w-full md:w-1/3 px-4 mb-4">
                <div class="relative rounded-lg overflow-hidden">
                    <img src="{{ asset('images/product3.jpg') }}" alt="Coconut Palm Sugar Image"
                        class="w-full h-full object-cover" />
                    <div class="absolute bottom-0 left-0 bg-opacity-50 p-4 w-full">
        ...
        <div class="flex item-center justify-center p-10">
            ...
            <div class="product-custom w-1/2 p-10">
                ...
                <p class="mb-6  ">We commit to delivering only high-quality coconut products to you. Our products are made
                    from fresh and high-quality raw materials.</p>
                <a href="/product">
        ...
        <div class="container mx-auto mt-24 mb-24">
            <div class="flex flex-wrap justify-center">
                <div
                    class="product mx-10 my-8 text-center border border-gray-300 rounded-lg overflow-hidden shadow-md transition duration-300 hover:shadow-lg">
                    <a href="{{ '/product' }}">
            ...
            <div class="mt-15 table-request">
                <a href="/product">
                    <button class="button-custom text-white text-x font-bold px-4 py-2 rounded-full mt-10">EXPLORE ALL
                        PRODUCTS</button>
                </a>
            </div>
        </div>
