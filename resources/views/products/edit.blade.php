        ...
        <div class="w-full ">
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 ">
                    <div class="text-left">
                        <h2 class="text-3xl font-semibold flex items-center justify-center mb-4 font-serif">Edit Product
                        </h2>
                    ...
                    <div class="form-group">
                        ...
                        px-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            value="{{ $product->product }}" placeholder="Product">
                    </div>
                    <div class="form-group">
                    ...
                    px-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" value="{{ $product->price }}" placeholder="Price">
                </div>
                    <div class="form-group">
                        ...
                        <input type="number" name="stock" id="stock" class="block w-full bg-gray-50 text-gray-700 border border-gray-300 rounded-lg
                         py-2 px-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            value="{{ $product->stock }}" placeholder="Stock">
                    </div>
                    <div class="text-center">
                        <button type="submit"
                            class="cub button-custom text-white text-left rounded-md size-1/7 py-1.5 px-3 rounded-lg mb-2">Update</button>
                    </div>
                </div>
            </form>
        </div>
