...
<div id="default-carousel" class="relative w-full h-full mt-10 py-10" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-100 overflow-hidden md:h-96">
        <!-- Item 1 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('images/cocshell-1.jpg') }}"
        ...
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('images/cocshell-3.jpg') }}"
                class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
...
<div>
    ...
    <div class="containerrawcoconut table-request w-full max-w-7xl mx-auto mt-10 ml-48">
        <div>
            <p class="bigword text-4xl font-bold text-blue-900 mt-12">COCONUT SHELL</p>
