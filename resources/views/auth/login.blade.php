...
<body>
  ...
  <br><p class="text-center mt-4">Don't have an account yet?
      <a href="{{ route('register') }}" class="text-center text-blue-600 hover:text-blue-800 hover:underline">Register</a></p>
</form>
        </div>
    </div>
</body>
