...
<div class="containerrawcoconut w-full max-w-7xl mx-auto mt-10 ml-48">
    <div>
        ...
        <p class="detail text-base font-sans text-gray-500 mt-8">Coconut Sugar is dried meat of coconut that are cut
            in half. There are three basic grades of copra. The lowest grade of copra has a bit black or yellowing
            color, and commonly used for the production of RBD Coconut Oil.</p>
    </div>
</div>
