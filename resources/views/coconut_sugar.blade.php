...
<div id="default-carousel" class="relative w-full h-full mt-10 py-10" data-carousel="slide">
    ...
    <div class="relative h-86 overflow-hidden md:h-96">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('images/cocsugar-1.jpg') }}"
                class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('images/cocsugar-2.jpg') }}"
                class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
...
<div>
    ...
    <div class="containerrawcoconut table-request w-full max-w-7xl mx-auto mt-10 ml-48">
        <div>
            <p class="bigword text-4xl font-bold text-blue-900 mt-12">COCONUT SUGAR</p>
            ...
            <p class="detail text-base font-sans text-gray-500 mt-8">Lorem ipsum, dolor sit amet consectetur adipisicing
                elit. Perferendis reprehenderit enim iste, incidunt minima saepe libero voluptatibus eaque, omnis
                adipisci ex quasi, accusantium rerum nam sequi neque repellat ut aut!</p>
        </div>
    </div>
