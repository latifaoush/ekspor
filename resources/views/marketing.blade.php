            ...
            <li>
                <a href="/marketing"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        class="bi bi-bag-plus-fill flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        viewBox="0 0 16 16">
